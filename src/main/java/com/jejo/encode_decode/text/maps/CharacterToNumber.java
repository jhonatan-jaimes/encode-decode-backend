...
public class CharacterToNumber {
    public static final Map<String, String> characterToNumber = new HashMap<>();
    static {
     ...
     * devuelve el valor.
     * */
    public static List<String> codeToNumber(String letras) {
        List<String> lista = new ArrayList<>();
        int count = 0;
        for (char i : letras.toCharArray()){
            lista.add(count++, getNumero(String.valueOf(i)));
        }
        return lista;
    }

    public static String getNumero(String letra) {

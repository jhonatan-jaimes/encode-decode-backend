...
public class CharacterToCode {
    public static final Map<String, String> bibliotecaGeneralL = new HashMap<>();

    static {
        // Números a dos letras
        bibliotecaGeneralL.put("0", "zz");
    ...
    public static String getValue(String key) {
        if(bibliotecaGeneralL.containsKey(key)){
            ...
            throw new IllegalArgumentException("La letra, " + key + " no puede ser codificada");
        }
